...
/* BOILERPLATE: Add or remove entries here when you add/remove pages */
const navItems = [
  { label: 'Overview', path: '/' },
  { label: 'Trade by State', path: '/trade-by-state' },
  { label: 'Commodities', path: '/commodities' },
  { label: 'Transportation Mode', path: '/trade-by-mode' },
  { label: 'TX Border Ports', path: '/border-ports' },
]
